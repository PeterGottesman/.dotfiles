...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eglot conda ninja-mode diffview lua-mode org-ref annotate julia-mode rmsbolt disaster company-lsp company yasnippet helm-projectile helm evil-leader evil edbi edbi-database-url edbi-django edbi-sqlite emacsql emacsql-sqlite3 rjsx-mode tuareg bison-mode tex-site acutex auctex cuda-mode switch-window ivy-explorer counsel swiper projectile lsp-treemacs flycheck lsp-ui lsp-mode yaml-mode counsel-gtags glsl-mode elpy pdf-tools gh-md markdown-mode company-go go-mode origami company-statistics company-quickhelp company-c-headers use-package multi-term paganini-theme hl-todo magit package-build))
